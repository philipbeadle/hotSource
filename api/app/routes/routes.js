...
var postRegister = require('./postRegister.js');
var postAuthenticate = require('./postAuthenticate')
// Set up middleware
...
module.exports = function (app) {
  ...
  // Register new users
  apiRoutes.post('/register', postRegister);

  // Authenticate the user and get a JSON Web Token to include in the header of future requests.
  apiRoutes.post('/authenticate', postAuthenticate);
